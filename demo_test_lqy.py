...
def main(args):
    ...
    # RNet = caffe.Net(caffe_model_path+"/det2.prototxt", caffe_model_path+"/det2.caffemodel", caffe.TEST)
    # ONet = caffe.Net(caffe_model_path+"/det3.prototxt", caffe_model_path+"/det3.caffemodel", caffe.TEST)
    PNet = caffe.Net(caffe_model_path+"/12net.prototxt", caffe_model_path+"/PNet_iter_1200000.caffemodel", caffe.TEST)
    RNet = caffe.Net(caffe_model_path+"/24net.prototxt", caffe_model_path+"/RNet_iter_1200000.caffemodel", caffe.TEST)
    ONet = caffe.Net(caffe_model_path+"/48net.prototxt", caffe_model_path+"/ONet_iter_1200000.caffemodel", caffe.TEST)
    ...
    for img_path in imgs_path:
        ...
        img_matlab = copy.deepcopy(img)
        # img_matlab = img_matlab[:,:,::-1]
        ...
        boundingboxes, points = mtcnn_detector.detect_single_image(img_matlab)
        #toc()
